...
class CreateUsers < ActiveRecord::Migration
  def change
    create_table :users do |t|
      ...
      t.column :phone_number, :string  #Email
      ...
      t.column :view_device_type, :string    #Was für ein Gerät benutzt die Person zum
      ...
      #t.belongs_to :department, :department # User gehören einem Department an
